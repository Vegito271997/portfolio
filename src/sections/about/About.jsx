      ...
      <section id="about" data-aos="fade-in">
        <div className="container about__container">
          ...
          <div className="about__right">
            ...
            <p>
              Hi! My name is Prateek Shukla from Lucknow, India. I'm a full-stack web developer with a bachelors
               degree in Electronics and Communication Engineering. My top priority is to get your business online the right way,
